    ...
    <>
      ...
      {!isOpen && (
        <motion.button
          ...
          className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-[60] p-3 sm:p-4 glass rounded-full shadow-lg hover:bg-primary-500/20 transition-colors group"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-[200px] sm:bottom-6 right-4 sm:right-6 z-[60] w-[calc(100vw-2rem)] sm:w-96 max-w-[calc(100vw-2rem)] sm:max-w-none h-[calc(100vh-12rem)] sm:h-[600px] max-h-[600px] glass rounded-2xl shadow-2xl backdrop-blur-xl flex flex-col overflow-hidden"
          >
            {/* Header */}
